        ...
        <GestureHandlerRootView style={{ flex: 1 }}>
          <View style={[styles.root, { backgroundColor: tc.background }]}>
            ...
            >
              ...
              {/* PDF Settings Card */}
              <View style={[styles.settingsCard, { backgroundColor: isDark ? '#18181B' : '#FFFFFF', borderColor: tc.border }]}>
                <Text style={[styles.nameInputLabel, { color: tc.textSecondary }]}>PDF SETTINGS</Text>
                ...
                <View style={styles.settingRow}>
                  ...
                  <View style={styles.chipRow}>
                    {(['portrait', 'landscape'] as const).map(v => (
                      <TouchableOpacity
                        key={v}
                        style={[styles.chip, { backgroundColor: orientation === v ? Brand.indigo : (isDark ? '#27272A' : '#F1F5F9') }]}
                ...
                <View style={[styles.settingDivider, { backgroundColor: tc.border }]} />
                ...
                <View style={styles.settingRow}>
                  ...
                  <View style={styles.chipRow}>
                    {(['a4', 'letter', 'fit'] as const).map(v => (
                      <TouchableOpacity
                        key={v}
                        style={[styles.chip, { backgroundColor: pageSize === v ? Brand.indigo : (isDark ? '#27272A' : '#F1F5F9') }]}
                ...
                <View style={styles.settingRow}>
                  ...
                  <View style={styles.chipRow}>
                    {(['none', 'small', 'large'] as const).map(v => (
                      <TouchableOpacity
                        key={v}
                        style={[styles.chip, { backgroundColor: margin === v ? Brand.indigo : (isDark ? '#27272A' : '#F1F5F9') }]}
                        onPress={() => setMargin(v)}
                        activeOpacity={0.75}
                      >
...
const styles = StyleSheet.create({
  ...
  settingTitle: { fontSize: 15, fontWeight: '600', letterSpacing: -0.2, paddingTop: 2 },
